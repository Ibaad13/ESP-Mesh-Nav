...
- [`fusion360/`](fusion360) — Native Fusion 360 design file(s) and/or exported `.step`/`.stl` files for the two-tier acrylic chassis.
...
| Part | Qty | Notes |
|---|---|---|
| Acrylic deck plates | 2 | Laser-cut, two-tier standoff design |
| Metal standoffs | 4 | Connects upper and lower decks |
...
Fill in exact part numbers/specs here once finalized — useful detail for anyone trying to reproduce the build.
