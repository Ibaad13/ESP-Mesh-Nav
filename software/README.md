...
- [`phase1_visualization/`](phase1_visualization) — RSSI-to-distance conversion, trilateration solver, and the live matplotlib visualization used for the Phase 1 results in the main README.
